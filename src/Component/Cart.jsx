...
function Cart() {
  ...
  const getDataUser = () => {
    onSnapshot(doc(db, "data", `${getAuth().currentUser.uid}`), (doc) => {
      setData(doc.data());
  ...
  const handleOnClick = async () => {
    ...
    getProducts();
    setDateStart(dayjs().format("DD-MM-YYYY"));
    setDateEnd(dayjs().format("DD-MM-YYYY"));
  };
  useEffect(() => {
    getDataUser();
    getProducts();
                              ...
                              <form className="bg-gray-200 shadow-md rounded px-12 pt-12 pb-8 w-full">
                                ...
                                <div className="relative max-w-sm">
                                  ...
                                  <input
                                    ...
                                    onChange={(event) =>
                                      setDateStart(dayjs(event.target.value))
                                    }
                                  />
                                </div>
                                <label className="block text-black text-sm font-bold mb-1">
                                ...
                                <div className="relative max-w-sm">
                                  ...
                                  <input
                                    ...
                                    onChange={(event) =>
                                      setDateEnd(dayjs(event.target.value))
                                    }
                                  />
                                </div>
                              </form>
